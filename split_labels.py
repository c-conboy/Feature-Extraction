...
def process_text_file(input_file, image_directory, train_file, test_file, test_image_directory):
...
if __name__ == "__main__":
    ...
    process_text_file(input_file, image_directory, train_file, test_file, test_image_directory)
